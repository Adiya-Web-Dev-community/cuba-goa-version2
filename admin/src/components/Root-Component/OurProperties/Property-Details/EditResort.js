...
const EditResort = ({
  ...
  const saveResort = async () => {
    ...
    if (roomImage) {
      data = {
        ...updatedResortForm,
        resortImgURL: roomImage,
        rooms: property.rooms,
      };
    } else {
      data = {
        ...updatedResortForm,
        resortImgURL: property.resortImgURL,
        rooms: property.rooms,
      };
    }
    ...
    await axios
      .put(`/entire-hotelbook/${property._id}`, data, {
        headers: {
      ...
      >
        ...
        <CModalBody>
          {updatedResortForm.resortImgURL ? (
            <div
              className="mb-4 editResortDeleteImg"
            ...
            >
              <CImage
                ...
                width={300}
                height={200}
                src={updatedResortForm.resortImgURL}
              />
              <button onClick={deleteImage} className="editResortDeleteIcon">
                <RiDeleteBin5Fill />
              </button>
            </div>
          ) : null}
          ...
          <div className="mb-4">
            <CFormInput
              label="Resort Name"
              value={updatedResortForm.resortName}
              maxLength={50}
              onChange={handleEditResortForm("resortName")}
            />
          </div>
          <div className="mb-4">
            <CFormInput
              ...
              value={updatedResortForm.resortLocation}
              onChange={handleEditResortForm("resortLocation")}
            />
          </div>
          <div className="mb-4">
            <CFormInput
              ...
              value={updatedResortForm.resortAddress}
              onChange={handleEditResortForm("resortAddress")}
            />
          </div>
          <div className="mb-4">
            <CFormInput
              ...
              maxLength={2000}
              label="Pincode"
              value={updatedResortForm.pincode}
              onChange={handleEditResortForm("pincode")}
            />
          </div>
          <div className="mb-4">
            <CFormTextarea
              ...
              maxLength={5000}
              value={updatedResortForm.resortDescription}
              onChange={handleEditResortForm("resortDescription")}
            />
          </div>
            ...
            <CCardBody className="p-4">
              <div className="mb-4">
                <CFormInput
                  ...
                  maxLength={5000}
                  value={updatedResortForm.resortPhoneNumber}
                  onChange={handleEditResortForm("resortPhoneNumber")}
                />
              </div>
              <div className="mb-4">
                <CFormInput
                  label="Resort Email"
                  maxLength={5000}
                  value={updatedResortForm.resortEmail}
                  onChange={handleEditResortForm("resortEmail")}
                />
              </div>
              <div className="mb-4">
                <CFormInput
                  label="Cuba Goa Helpline Number"
                  maxLength={5000}
                  value={updatedResortForm.cubaGoaHelpLineNumber}
                  onChange={handleEditResortForm("cubaGoaHelpLineNumber")}
                />
              </div>
            </CCardBody>
          </CCard>
        ...
        <CModalFooter>
          <CButton
            color="secondary"
            onClick={() => setShowEditResortForm(false)}
          >
            Close
          </CButton>
          <CButton
