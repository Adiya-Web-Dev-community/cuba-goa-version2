    ...
    <>
      <div className="my-bookings-wrapper">
        <div className="heading">
          <h3 style={{ fontFamily: "Geomanist", textAlign: "center" }}>
            BOOKINGS
          </h3>
        </div>
        ...
        <div className="wrapper">
          {list.length <= 0 ? (
            <h1 style={{ opacity: "0.4", textAlign: "center", margin: "auto" }}>
              No Bookings yet !
            </h1>
          ) : (
            list.map((booking, i) => {
                ...
                <div className="booking-card" key={i + 1}>
                  ...
                  <div className="booking-rate">
                    <p
                      ...
                      style={{ fontFamily: "Rajdhani, sans-serif" }}
                    >
                      Total amount paid:Rs.{booking.totalAmount}
                    </p>
                  </div>
                  ...
                  <div className="revbtn-wrap">
                    ...
                    <div className="review-btn-wrap1">
                      <button
                        ...
                        onClick={() => handleFeedbackButton(booking.resortId)}
                      >
                        Add Review
                      </button>
                    </div>
