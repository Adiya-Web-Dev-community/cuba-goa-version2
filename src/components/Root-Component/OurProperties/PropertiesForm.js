    ...
    <>
      ...
      >
        ...
        <CModalBody>
          ...
          <div className="mb-4">
            <CFormInput
              value={resortForm.resortName}
              label="Resort Name"
              maxLength={50}
              onChange={handleResortForm("resortName")}
            />
          </div>
          <div className="mb-4">
            <CFormInput
              value={resortForm.resortLocation}
              type="text"
              size="sm"
              maxLength={2000}
              label="Resort Location"
              onChange={handleResortForm("resortLocation")}
            />
          </div>
          <div>
            <CFormTextarea
              value={resortForm.resortAddress}
              label="Resort Address"
              maxLength={5000}
              onChange={handleResortForm("resortAddress")}
            />
          </div>
          <div>
            <CFormTextarea
              value={resortForm.pincode}
              label="Pincode"
              maxLength={5000}
              onChange={handleResortForm("pincode")}
            />
          </div>
          <div>
            <CFormTextarea
              value={resortForm.resortDescription}
              label="Resort Description"
              maxLength={5000}
              onChange={handleResortForm("resortDescription")}
            />
          </div>
          ...
          <CCard className="mx-2 mt-4">
            ...
            <CCardBody className="p-4">
              <div className="mb-4">
                <CFormTextarea
                  value={resortForm.resortPhoneNumber}
                  label="Resort Phone Number"
                  maxLength={5000}
                  onChange={handleResortForm("resortPhoneNumber")}
                />
              </div>
              <div className="mb-4">
                <CFormTextarea
                  value={resortForm.resortEmail}
                  label="Resort Email"
                  maxLength={5000}
                  onChange={handleResortForm("resortEmail")}
                />
              </div>
              <div className="mb-4">
                <CFormTextarea
                  value={resortForm.cubaGoaHelpLineNumber}
                  label="Cuba Goa Helpline Number"
                  maxLength={5000}
                  onChange={handleResortForm("cubaGoaHelpLineNumber")}
                />
              </div>
            </CCardBody>
          </CCard>
