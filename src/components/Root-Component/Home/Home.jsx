    ...
    <>
      <main className="Home">
        ...
        <div className="entry-content">
          <div className="mid">
            <h2 className="entry-title">
              Own your own piece of Ontario’s Cottage Country at Cuba gua.
            </h2>
          </div>
          <div className="large-columns">
            <p>
              Welcome to Cuba gua where you will find the perfect city escape
              that includes all the amenities your family comes to expect from a
              resort – heated pools, multi-sports courts and playgrounds, and
              best of all, sandy combed beaches. Think stunning views, beautiful
              surroundings and endless options for outdoor adventure, for sale
              or rent.
            </p>
            <p>
              When you step inside your new home-away-from-home you’ll find the
              start of many family memories. Professionally designed, fully
              furnished and includes all your appliances so you have all the
              comforts of home. Enjoy stress-free and virtually maintenance-free
              cottage ownership along with all-inclusive amenities, full family
              entertainment and more! Choose from nine great Ontario locations
              in highly sought after Muskoka, Prince Edward County, The
        ...
        <div className="npCallout">
          ...
          <div className="img-slider-content">
            <div>
              ...
              <h3>
                New Phases of <br /> Development for 2023
              </h3>
              <p>
                This exciting opportunity allows owners to select their
                preferred lot and new <br />
                cottage model within the phase.
              </p>
              <p>&nbsp;</p>
              {/* <p>
        ...
        <section className="cottages-slide cottages-slide-2">
          <div className="add-new-cottages-parent"></div>
        </section>
